...
Install lastest version of plugin on you server
...
Firts, Flowcharting uses uniq id of objets to know witch is candidate of mapping values/conditions.
In next release mapping well possible with values content or attributes.
...
Go to inspect Tab, and double click on id with the names in the table below.
...
Then click on button 'Apply change' or 'Reinit' to cancel change.
